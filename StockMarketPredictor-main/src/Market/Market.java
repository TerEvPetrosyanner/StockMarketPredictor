...
public class Market {
    public static class Event {
        ...
        private final CustomSlowMap<Integer, BigDecimal> effect = new CustomSlowMap<>(new Integer[]{0,1,2,3,4,5,6},
                new BigDecimal[]{new BigDecimal(0.92), new BigDecimal(0.95),new BigDecimal(1.05),new BigDecimal(0.91),new BigDecimal(1.20),new BigDecimal(0.90), new BigDecimal(1.3) });
